...
- **Generated:** 2026-06-03T14:00:32.678551-05:00
...
- **Δ PPL:** +0.00%
- **Compression ratio:** 21.33x
- **Pool size:** 18,875,280 bytes
- **Total compressed:** 18,875,280 bytes
...
2. **Phase 1 (compressed roundtrip):**
   ...
   - Invoke `prove_kv_fast_roundtrip` CLI (composite build + parallel decompress) (89.1s)
...
- `prove_kv_corpus.json` — Phase 1 input to the proveKV CLI
- `roundtrip.bin` — Phase 1 binary output (manifest + 24 layer blobs)
- `manifest` (in `roundtrip.bin`) — pool manifest from proveKV
...
- Phase 0 forward: 1.5s
- Phase 1 roundtrip CLI: 89.1s
- Phase 1 forward with pre-populated cache: 1.6s
