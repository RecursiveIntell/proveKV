...
- **Generated:** 2026-06-03T14:03:11.305541-05:00
...
2. **Phase 1 (compressed roundtrip):**
   ...
   - Invoke `prove_kv_fast_roundtrip` CLI (composite build + parallel decompress) (74.7s)
...
- Phase 0 forward: 1.7s
- Phase 1 roundtrip CLI: 74.7s
